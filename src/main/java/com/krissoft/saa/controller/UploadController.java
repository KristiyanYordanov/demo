...
public class UploadController {
	...
	String upload(MultipartHttpServletRequest request,
		...
		return "<img src='http://localhost:8080/spring-jpa/cont/get/"
				+ Calendar.getInstance().getTimeInMillis() + "' />";

	}

	@RequestMapping(value = "/uploadAndShow", method = RequestMethod.POST)
	public @ResponseBody
	String uploadAndShow(MultipartHttpServletRequest request,
			HttpServletResponse response) {
